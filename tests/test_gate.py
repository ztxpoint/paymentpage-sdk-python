...
class GateTest(unittest.TestCase):
    secret = 'qwerty'
    compare_url = \
        'https://paymentpage.ztxpoint.com/payment?project_id=1&interface_type=%7B%22id%22%3A%2024%7D' \
    ...
    def test_get_purchase_payment_page_url(self):
        ...
        purchase_payment_page_url = self.gate.get_purchase_payment_page_url('https://paymentpage.ztxpoint.com', payment)
